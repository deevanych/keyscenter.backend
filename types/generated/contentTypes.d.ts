...
export interface ApiCarouselCarousel extends Schema.CollectionType {
  ...
  attributes: {
    ...
    carousel_items: Attribute.Relation<
...
export interface ApiCartCart extends Schema.CollectionType {
  ...
  attributes: {
    ...
    items: Attribute.Component<'cart.item', true>;
    sum: Attribute.Integer &
      Attribute.SetMinMax<{
        min: 0;
      }> &
...
export interface ApiCouponCoupon extends Schema.CollectionType {
  ...
  attributes: {
    ...
    discount_type: Attribute.Enumeration<['percent', 'amount']> &
      Attribute.DefaultTo<'percent'>;
    applies_count: Attribute.Integer &
      Attribute.SetMinMax<{
        min: 0;
      }> &
      Attribute.DefaultTo<0>;
    max_applies_count: Attribute.Integer &
      Attribute.SetMinMax<{
        min: -1;
      }> &
      Attribute.DefaultTo<-1>;
    can_be_applied_with_other: Attribute.Boolean & Attribute.DefaultTo<true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiCtaCta extends Schema.CollectionType {
  ...
  attributes: {
    ...
    product: Attribute.Relation<
      ...
      'api::product.product'
    >;
    page: Attribute.Relation<'api::cta.cta', 'oneToOne', 'api::page.page'>;
    action: Attribute.Text &
      Attribute.SetPluginOptions<{
        versions: {
          versioned: true;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    product_keys: Attribute.Relation<
      'api::order.order',
      'oneToMany',
    ...
    >;
    paid_at: Attribute.DateTime;
    is_goal_sent: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::order.order',
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    slug: Attribute.UID<'api::product.product', 'title'> & Attribute.Unique;
    ...
    activation_by_phone: Attribute.Boolean & Attribute.DefaultTo<true>;
    instruction_page: Attribute.Relation<
      'api::product.product',
      'oneToOne',
      'api::page.page'
    >;
